...
LAYOUTS = {
    ...
    'full':            (3, 780, 39, 460, 18, 44, 24, 1, 36, 35, 'true', 38),
    'half_horizontal': (3, 780, 39, 220, 18, 36, 16, 3, 36, 35, 'true', 26),
    'half_vertical':   (2, 380, 40, 460, 18, 44, 22, 2, 24, 23, 'false', 38),
    'quadrant':        (2, 380, 34, 220, 18, 36, 15, 3, 25, 24, 'false', 26),
}
